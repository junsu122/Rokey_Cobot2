...
GIVE_JOINT          = [51.87, 26.97, 69.98, 0.00, 83.32, 51.74]
GIVE_LINE           = [332.04, 435.57, 80.00, 32.23, -179.72, 31.98]
WAY_POINT_JOINT     = [1.12, 2.78, 67.88, -0.13, 109.65, 0.87]
...
ABS_VEL      = 400.0
ABS_ACC      = 500.0
ABS_BLEND_R  =   80.00 # 50.00 -> 80.00
POS_THR_MM   =   3.0 # 1.5 -> 3.0
ABS_MAX_STEP =  50.0

MIN_STEP_MM    = 0.3 # 0.5 -> 0.3
MAX_STEP_MM    = 80.0
SMOOTH_ALPHA   = 0.6
CMD_CHANGE_THR = 0.2 # 0.3 -> 0.2
