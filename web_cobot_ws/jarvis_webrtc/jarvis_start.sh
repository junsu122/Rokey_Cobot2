...
source ~/Rokey_Cobot2/web_version_git/jarvis_webrtc/jarvis_helpers.sh
...
# ── 1단계: ROS2 노드 그룹 ────────────────────────────────────────────────────
echo ""
bash ~/Rokey_Cobot2/web_version_git/jarvis_webrtc/jarvis_ros.sh
if [ $? -ne 0 ]; then
...
# ── 2단계: 웹 서버 그룹 ─────────────────────────────────────────────────────
bash ~/Rokey_Cobot2/web_version_git/jarvis_webrtc/jarvis_web.sh
if [ $? -ne 0 ]; then
...
echo ""
echo "  개별 재시작:"
echo "    bash ~/Rokey_Cobot2/web_version_git/jarvis_webrtc/jarvis_ros.sh   # ROS만"
echo "    bash ~/Rokey_Cobot2/web_version_git/jarvis_webrtc/jarvis_web.sh   # 웹만"
echo ""
